...
export const StockAlertBanner: React.FC = () => {
  ...
  if (criticalItems.length > 0) {
    return (
      <div className="bg-red-50 dark:bg-red-950/60 border-l-4 border-red-600 p-4 rounded-xl shadow-xs mb-6 flex items-start gap-3.5 animate-fade-in">
  ...
  if (warningItems.length > 0) {
    return (
      <div className="bg-amber-50 dark:bg-amber-950/60 border-l-4 border-amber-500 p-4 rounded-xl shadow-xs mb-6 flex items-start gap-3.5 animate-fade-in">
  ...
  return (
    <div className="bg-emerald-50 dark:bg-emerald-950/50 border-l-4 border-emerald-500 p-3.5 rounded-xl shadow-xs mb-6 flex items-center gap-3">
