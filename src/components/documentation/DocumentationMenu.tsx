...
export const DocumentationMenu: React.FC<DocumentationMenuProps> = ({ items, activeId, onSelect }) => {
  return (
    <aside className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 sm:p-4 h-full">
      <div className="flex items-center gap-2 px-2 py-2 mb-2">
        <FileStack className="w-4 h-4 text-blue-600 dark:text-blue-400" />
        <h3 className="text-xs font-black uppercase tracking-wider text-slate-600 dark:text-slate-300">Módulos</h3>
      </div>
