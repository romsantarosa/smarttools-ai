    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs rounded-xl transition-all shadow-md flex items-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-black text-xs rounded-xl transition-all shadow-md flex items-center gap-2 disabled:opacity-50 cursor-pointer"
            >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Atracados BTP</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Previstos</span>
            <span className="text-xl font-black text-slate-900 dark:text-white">
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Movimentos</span>
            <span className="text-xl font-black text-slate-900 dark:text-white">
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Próx. Refresh</span>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 sm:p-5 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white text-xs font-bold focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-2 cursor-pointer ml-auto ${
              activeTab === 'api'
      ...
      {loading ? (
        ...
        <div className="p-8 text-center bg-rose-50 dark:bg-rose-950/40 rounded-2xl border border-rose-200 dark:border-rose-900 space-y-3">
          ...
          <h4 className="font-extrabold text-rose-800 dark:text-rose-200 text-base">Falha na integração com o portal</h4>
              ...
              <div className="flex items-center justify-between text-xs text-slate-500 font-bold px-1">
                ...
                <span className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 rounded-lg text-[11px] font-extrabold flex items-center gap-1 cursor-pointer"
                  >
...
<div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700 space-y-2 text-xs">
  ...
  {ship.agencia && (
    <div className="flex items-center justify-between">
      <span className="text-slate-400 font-bold">Agência:</span>
  ...
  {ship.pratico && (
    <div className="flex items-center justify-between">
      <span className="text-slate-400 font-bold">Prático:</span>
      <span className="font-bold text-slate-700 dark:text-slate-300">
        {ship.pratico}
      </span>
    </div>
                      ...
                      <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
                        <button
                          ...
                          className="w-full py-2 bg-slate-900 dark:bg-slate-800 hover:bg-blue-600 text-white font-bold text-xs rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer"
                        >
                  ...
                  <table className="w-full text-left border-collapse text-xs">
                    <thead>
                      <tr className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-black border-b border-slate-200 dark:border-slate-700">
                        ...
                        <th className="p-3.5">BERÇO BTP</th>
                        <th className="p-3.5">HORÁRIO / DATA</th>
                        <th className="p-3.5">SITUAÇÃO</th>
                        <th className="p-3.5">AGÊNCIA / PRÁTICO</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-800 dark:text-slate-200">
                      {filteredPrevistas.map((ship, idx) => (
                        <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                          <td className="p-3.5 font-mono text-slate-500">{ship.imo}</td>
                          <td className="p-3.5 font-black text-slate-900 dark:text-white">{ship.navio}</td>
                          <td className="p-3.5 font-mono text-slate-400">{ship.mv || '-'}</td>
                          <td className="p-3.5">
                            <span className="px-2 py-0.5 rounded bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 font-extrabold text-[11px]">
                              {ship.movimento}
                            </span>
                          </td>
                          <td className="p-3.5">
                            <span className="px-2 py-0.5 rounded bg-slate-200 dark:bg-slate-700 font-black text-slate-900 dark:text-white">
                              {ship.berco}
                            </span>
                          </td>
